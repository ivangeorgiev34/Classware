        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Compliments_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Compliments_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Compliments_Teachers_TeacherId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "English language" },
                    { 2, true, "Bulgarian language" },
                    { 3, true, "Mathematics" },
                    { 4, true, "Physical education" },
                    { 5, true, "Information technologies" },
                    { 6, true, "Informatics" },
                    { 7, true, "Geography" },
                    { 8, true, "History" },
                    { 9, true, "Physics" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Compliments_StudentId",
                table: "Compliments",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Compliments_SubjectId",
                table: "Compliments",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Compliments_TeacherId",
                table: "Compliments",
                column: "TeacherId");
